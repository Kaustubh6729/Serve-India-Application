...
import 'Pothole_requests/completed_requests.dart';
import 'Pothole_requests/in_progress_requests.dart';
import 'Pothole_requests/new_requests.dart';
import 'Pothole_requests/pending_requests.dart';

class Pothole extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Pothole Department Page"),
